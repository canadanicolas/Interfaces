...
document.addEventListener('DOMContentLoaded', changeParallax);

function changeParallax(){
  let i=2;
  setInterval(function() {
    if (i == 1){
      document.getElementById("img-parallax").src="./Img/vetBackground4.jpg";
      i++;
    }
    else if (i == 2){
      document.getElementById("img-parallax").src="./Img/vetBackground1.jpg";
      i++;
    }
    else if (i == 3){
      document.getElementById("img-parallax").src="./Img/vetBackground6.jpg";
      i=1;
    }
  ;}, 5000);
}
